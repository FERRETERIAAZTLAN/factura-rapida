...
if (migrationPos < 0 || firstAppScriptPos < 0 || migrationPos > firstAppScriptPos + 300) {
  throw new Error('La migración de almacenamiento no quedó al inicio del documento');
}
...
console.log(`FINALIZE WINDOWS HTML OK ${appVersion}: almacenamiento WebView2 versionado se limpia antes del arranque y puentes nativos quedan preservados.`);
