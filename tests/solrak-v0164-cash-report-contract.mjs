...
assert(code.includes("posApi('closeCash'"),'El cierre dejó de usar la operación productiva');
assert(code.includes("posApi('completeSale'"),'La venta atómica dejó de estar conectada');
assert(code.includes('payments:[payment]'),'Cambió el contrato productivo de pagos');
