(() => {
  ...
  function injectStyle() {
    ...
    style.id = STYLE_ID;
    style.textContent = `
:root{--solrak-accent:#2387d9;--solrak-accent-strong:#1768ad;--solrak-accent-soft:#eaf4fd;--solrak-side-expanded:246px;--solrak-side-collapsed:62px;--solrak-side-current:var(--solrak-side-expanded);--solrak-ops-height:76px;--solrak-action-height:52px;--fiel-orange:var(--solrak-accent);--fiel-orange-dark:var(--solrak-accent-strong)}
html[data-solrak-sidebar-collapsed="1"]{--solrak-side-current:var(--solrak-side-collapsed);--fiel-side:var(--solrak-side-collapsed)}html[data-solrak-sidebar-collapsed="0"]{--solrak-side-current:var(--solrak-side-expanded);--fiel-side:var(--solrak-side-expanded)}
#solrakFielSidebar{width:var(--solrak-side-current)!important;transition:width .16s ease!important;overflow:hidden!important}html[data-solrak-sidebar-collapsed="1"] #solrakFielSidebar .fielBrandText,html[data-solrak-sidebar-collapsed="1"] #solrakFielSidebar .fielMenuItem>span:not(.solrakKeepCollapsed),html[data-solrak-sidebar-collapsed="1"] #solrakFielSidebar .fielMenuGroup>span,html[data-solrak-sidebar-collapsed="1"] #solrakFielSidebar .fielBadge,html[data-solrak-sidebar-collapsed="1"] #solrakFielSidebar .fielChevron,html[data-solrak-sidebar-collapsed="1"] #solrakFielSidebar .fielFinish{display:none!important}html[data-solrak-sidebar-collapsed="1"] #solrakFielSidebar .fielBrand{padding:7px 8px!important;justify-content:center!important}html[data-solrak-sidebar-collapsed="1"] #solrakFielSidebar .fielBrandMark{display:none!important}html[data-solrak-sidebar-collapsed="1"] #solrakFielSidebar .fielMenuItem,html[data-solrak-sidebar-collapsed="1"] #solrakFielSidebar .fielMenuGroup{width:62px!important;min-width:62px!important;padding:0!important;justify-content:center!important;border-left-width:0!important}html[data-solrak-sidebar-collapsed="1"] #solrakFielSidebar .fielMenuItem>svg,html[data-solrak-sidebar-collapsed="1"] #solrakFielSidebar .fielMenuGroup>svg{width:21px!important;height:21px!important;flex-basis:21px!important}html[data-solrak-sidebar-collapsed="1"] #solrakFielSidebar .fielSubmenu{display:none!important}.solrakHamburger{margin-left:auto;width:36px;height:36px;border:0;border-radius:5px;background:rgba(255,255,255,.13);color:#fff;display:grid;place-items:center;font-size:20px;line-height:1;cursor:pointer}.solrakHamburger:hover{background:rgba(255,255,255,.22)}html[data-solrak-sidebar-collapsed="1"] .solrakHamburger{margin:0!important;width:38px;height:38px}
html[data-solrak-fiel="1"] main.shell{margin-left:var(--solrak-side-current)!important;transition:margin-left .16s ease!important}#solrakFielSidebar .fielBrand,html[data-solrak-fiel="1"] main.shell>.top,.fielDialogHead,.fielConfigTabs{background:linear-gradient(90deg,var(--solrak-accent-strong),var(--solrak-accent))!important}#solrakFielSidebar .fielMenuItem.active{border-left-color:var(--solrak-accent)!important;background:var(--solrak-accent-soft)!important}.fielField{border-bottom-color:var(--solrak-accent)!important}.fielSearchIcon,.fielBtn.orange,.fielBtn.primary,.fielFinish{background:var(--solrak-accent)!important;border-color:var(--solrak-accent)!important}.fielColor.active{border-color:var(--solrak-accent-strong)!important}
html[data-solrak-fiel="1"][data-solrak-professional-pos="1"] #tab-pos{height:calc(100vh - var(--fiel-top))!important;display:grid!important;grid-template-rows:var(--solrak-ops-height) minmax(0,1fr) var(--solrak-action-height)!important;padding:0!important;overflow:hidden!important;background:#f3f5f7!important}html[data-solrak-fiel="1"] #tab-pos>.frPosTop{display:none!important}
#solrakOpsBar{grid-row:1;display:grid;grid-template-columns:150px 62px minmax(310px,1fr) 205px 42px;gap:8px;align-items:center;height:var(--solrak-ops-height);padding:8px 10px;border-bottom:1px solid #d7dde2;background:#fff;box-sizing:border-box;min-width:0}.solrakOpsMetric{height:58px;display:flex;align-items:center;gap:9px;padding:7px 10px;border:1px solid #dfe4e8;background:#fafbfc;box-sizing:border-box;min-width:0}.solrakOpsMetric .solrakOpsIcon{font-size:18px;color:var(--solrak-accent)}.solrakOpsMetric span{display:block;font-size:9px;text-transform:uppercase;letter-spacing:.08em;color:#74808a}.solrakOpsMetric strong{display:block;margin-top:2px;font-size:18px;color:#27313a;white-space:nowrap}.solrakScaleMeta{font-size:8px!important;text-transform:none!important;letter-spacing:0!important}#solrakSelectedThumb{width:58px;height:58px;border:1px solid #dfe4e8;background:#fff;display:grid;place-items:center;overflow:hidden}#solrakSelectedThumb img{width:100%;height:100%;object-fit:contain}.solrakThumbEmpty{font-size:8px;color:#89949d;text-align:center;line-height:1.2;padding:4px}#solrakTicketSlot{min-width:0;height:58px;overflow:hidden}#solrakTicketSlot .frTicketBar{display:flex!important;align-items:stretch!important;gap:5px!important;height:58px!important;margin:0!important;padding:0!important;overflow-x:auto!important;overflow-y:hidden!important;max-height:none!important;scrollbar-width:thin}#solrakTicketSlot #posTickets{display:flex!important;flex-direction:row!important;gap:5px!important;min-width:max-content!important}#solrakTicketSlot .frTicket{width:122px!important;min-width:122px!important;min-height:54px!important;height:54px!important;border-radius:4px!important;padding:6px 7px!important}#solrakTicketSlot .frTicket.active{border-color:var(--solrak-accent)!important;background:var(--solrak-accent-soft)!important;color:var(--solrak-accent-strong)!important;box-shadow:inset 0 -3px 0 var(--solrak-accent)!important}#solrakTicketSlot .frTicketNew{min-width:98px!important;width:98px!important;min-height:54px!important;height:54px!important;margin:0!important;border-radius:4px!important}.solrakTopTotal{height:58px;display:flex;align-items:center;justify-content:flex-end;gap:10px;padding:5px 12px;background:#232a31;color:#fff;box-sizing:border-box}.solrakTopTotal span{font-size:10px;text-transform:uppercase;letter-spacing:.1em;opacity:.75}.solrakTopTotal strong{font-size:31px;line-height:1;font-variant-numeric:tabular-nums;white-space:nowrap}#solrakThemeButton{width:42px;height:58px;border:1px solid #dfe4e8;background:#fff;color:var(--solrak-accent);font-size:18px;cursor:pointer}
html[data-solrak-fiel="1"] #tab-pos>.frPosGrid{grid-row:2;height:100%!important;min-height:0!important;display:grid!important;grid-template-columns:minmax(0,1fr)!important;gap:0!important;background:#fff!important}html[data-solrak-fiel="1"] #tab-pos>.frPosGrid>.stack{height:100%!important;display:grid!important;grid-template-rows:52px minmax(0,1fr)!important;gap:0!important;min-height:0!important}html[data-solrak-fiel="1"] #tab-pos>.frPosGrid>.stack>article:first-child{position:relative!important;height:52px!important;min-height:52px!important;padding:7px 10px!important;overflow:visible!important;border-bottom:1px solid #dfe4e8!important;z-index:12!important}html[data-solrak-fiel="1"] #tab-pos>.frPosGrid>.stack>article:first-child .card-head,html[data-solrak-fiel="1"] #tab-pos>.frPosGrid>.stack>article:first-child .frPosHint{display:none!important}html[data-solrak-fiel="1"] #tab-pos>.frPosGrid>.stack>article:first-child #posSearch{height:38px!important;font-size:15px!important;padding:6px 12px!important}html[data-solrak-fiel="1"] #tab-pos #posResults{display:none!important;position:absolute!important;left:10px!important;right:10px!important;top:48px!important;z-index:50!important;max-height:340px!important;padding:6px!important;border:1px solid #cad2d9!important;background:#fff!important;box-shadow:0 14px 38px rgba(25,32,40,.2)!important}html[data-solrak-fiel="1"] #tab-pos.solrak-searching #posResults{display:grid!important}html[data-solrak-fiel="1"] #tab-pos>.frPosGrid>.stack>article:nth-child(3){display:none!important}html[data-solrak-fiel="1"] #tab-pos .frPosCartCard{height:100%!important;min-height:0!important;display:flex!important;flex-direction:column!important;border:0!important;border-radius:0!important;box-shadow:none!important;padding:0!important}html[data-solrak-fiel="1"] #tab-pos .frPosCartCard>.card-head{display:none!important}html[data-solrak-fiel="1"] #tab-pos .frPosCartCard>label{height:38px!important;min-height:38px!important;margin:0!important;padding:3px 10px!important;display:grid!important;grid-template-columns:135px minmax(0,460px)!important;align-items:center!important;gap:8px!important;border-bottom:1px solid #e0e4e7!important;font-size:10px!important;background:#fafbfc!important}html[data-solrak-fiel="1"] #tab-pos .frPosCartCard>label select{height:30px!important;padding:3px 7px!important}html[data-solrak-fiel="1"] #tab-pos .frPosCartHead,html[data-solrak-fiel="1"] #tab-pos .frPosLine{grid-template-columns:92px minmax(220px,1fr) 116px 112px 124px!important;gap:7px!important}html[data-solrak-fiel="1"] #tab-pos .frPosCartHead{min-height:29px!important;padding:6px 9px!important;background:#e7ebee!important;color:#4b5660!important;font-size:10px!important;text-transform:uppercase!important;font-weight:800!important}html[data-solrak-fiel="1"] #tab-pos .frPosCart{flex:1!important;min-height:0!important;max-height:none!important;overflow:auto!important;border:0!important;border-radius:0!important}html[data-solrak-fiel="1"] #tab-pos .frPosLine{min-height:43px!important;padding:5px 9px!important;border-bottom:1px solid #edf0f2!important;font-size:11px!important}html[data-solrak-fiel="1"] #tab-pos .frPosLine:hover{background:var(--solrak-accent-soft)!important}html[data-solrak-fiel="1"] #tab-pos .frPosLine strong{font-size:11px!important}html[data-solrak-fiel="1"] #tab-pos .frPosQty{height:28px!important;border-radius:3px!important}html[data-solrak-fiel="1"] #tab-pos .frPosQty button{width:27px!important}html[data-solrak-fiel="1"] #tab-pos .frPosQty input{width:54px!important;height:28px!important;padding:2px!important}html[data-solrak-fiel="1"] #tab-pos aside.summary{display:none!important}
...
`;
  ...
  function ensureSidebar() {
    ...
    if (menu && !sidebar.querySelector('[data-solrak-core="sales"]') && !sidebar.querySelector('[data-tab-target="pos"]')) {
      const sales = document.createElement("button");
      sales.type = "button";
      sales.className = "fielMenuItem";
      sales.dataset.solrakCore = "sales";
      sales.innerHTML = '<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M4 5h16v14H4zM7 9h10M7 13h6"/></svg><span>Ventas</span>';
      sales.onclick = () => { if (typeof window.switchTab === "function") window.switchTab("pos"); else byId("posTabBtn")?.click(); setTimeout(() => byId("posSearch")?.focus(), 20); };
      menu.prepend(sales);
    }
    ...
    if (!sidebar.dataset.solrakDensityBound) {
      ...
      sidebar.addEventListener("click", (event) => {
        if (document.documentElement.dataset.solrakSidebarCollapsed === "1" && event.target.closest("[data-fiel-group]")) setCollapsed(false);
      }, true);
    }
    return true;
  }
  ...
  function themeState() {
    try { const raw = localStorage.getItem(themeKey()); if (raw) return JSON.parse(raw); } catch {}
    return { name: "sky", custom: "#2387d9" };
  }
  function colorText(hex) {
    const clean = String(hex || "").replace("#", "");
    return /^[0-9a-f]{6}$/i.test(clean) ? `#${clean.toLowerCase()}` : "#2387d9";
  }
  ...
  function soften(hex) {
    const clean = colorText(hex).slice(1);
    const parts = [0, 2, 4].map((i) => { const n = parseInt(clean.slice(i, i + 2), 16); return Math.round(n + (255 - n) * 0.9); });
    return `#${parts.map((n) => n.toString(16).padStart(2, "0")).join("")}`;
  }
  function applyTheme(name, custom) {
    ...
    const resolved = preset ? name : "custom";
    const changed = document.documentElement.dataset.solrakTheme !== resolved || document.documentElement.style.getPropertyValue("--solrak-accent") !== accent;
    ...
    document.documentElement.dataset.solrakTheme = resolved;
    try { localStorage.setItem(themeKey(), JSON.stringify({ name: resolved, custom: accent })); } catch {}
    if (changed) renderThemeOptions();
    return { name: resolved, accent, strong, soft };
  }
  function ensureThemeDialog() {
    ...
    dialog.querySelector("[data-solrak-close]").onclick = () => closeDialog(dialog);
  ...
  function renderThemeOptions() {
    ...
    const markup = Object.entries(THEMES).map(([name, theme]) => `<button type="button" class="solrakThemeOption ${active === name ? "active" : ""}" data-solrak-theme="${name}"><span class="solrakThemeSwatch" style="--swatch:${theme.accent}"></span><span>${esc(theme.label)}</span></button>`).join("");
    ...
    if (byId("solrakCustomColor") && document.activeElement !== byId("solrakCustomColor")) byId("solrakCustomColor").value = colorText(state.custom || "#2387d9");
  }

  function selectedImageSnapshot() {
    const preview = byId("posProductPreview");
    const img = preview?.querySelector("img");
    const name = preview?.querySelector(".frPreviewMeta strong")?.textContent?.trim() || "";
  ...
  function syncProductThumb() {
    ...
    const markup = selected.src ? `<img src="${esc(selected.src)}" alt="${esc(selected.name || "Producto seleccionado")}">` : '<span class="solrakThumbEmpty">SIN<br>IMAGEN</span>';
    if (host.innerHTML !== markup) host.innerHTML = markup;
    host.title = selected.name || "Producto seleccionado";
  }
  function syncTopTotal() {
    const target = byId("solrakTopTotal"), value = byId("posTotal")?.textContent || "$0.00";
  ...
  function setScaleReading(detail) {
    ...
    const trusted = detail?.connected === true && ["device", "serial", "usb", "bluetooth"].includes(source);
    const value = Number(detail?.weight);
    if (!trusted || !Number.isFinite(value)) {
      if (weight.textContent !== "— kg") weight.textContent = "— kg";
      if (meta.textContent !== "Sin lectura real") meta.textContent = "Sin lectura real";
      return false;
    }
    const unit = String(detail?.unit || "kg").slice(0, 6), text = `${value.toFixed(3)} ${unit}`;
    if (weight.textContent !== text) weight.textContent = text;
    if (meta.textContent !== "Báscula conectada") meta.textContent = "Báscula conectada";
    return true;
  }
  function pollScaleBridge() {
    ...
    try {
      ...
      if (snapshot?.then) snapshot.then(setScaleReading).catch(() => setScaleReading(null));
      else setScaleReading(snapshot);
  ...
  function ensureOpsBar() {
    ...
    if (!bar) {
      ...
      byId("solrakThemeButton").onclick = () => { ensureThemeDialog(); showDialog(byId("solrakThemeDialog")); };
    }
    const ticketBar = tab.querySelector(".frTicketBar"), slot = byId("solrakTicketSlot");
    if (ticketBar && slot && ticketBar.parentElement !== slot) slot.appendChild(ticketBar);
    syncProductThumb(); syncTopTotal();
    return true;
  }
  ...
  function mayDiscount() {
    try { return currentSession()?.user?.role === "admin" || window.SOLRAKPermissionsV0179?.can?.("allow_discounts") === true; } catch { return false; }
  }
  ...
  function ensureLineEditor() {
    ...
    dialog.innerHTML = `<div class="solrakQuickHead"><span id="solrakLineTitle">Editar concepto</span><button type="button" data-solrak-close="solrakLineEditor">×</button></div><div class="solrakQuickBody"><div class="solrakQuickGrid"><label class="wide">Cantidad<input id="solrakLineQty" type="number" min="0.001" step="0.001"></label><label>Descuento<input id="solrakLineDiscountValue" type="number" min="0" step="0.01" disabled></label><label>Tipo<select id="solrakLineDiscountType" disabled><option value="percent">Porcentaje %</option><option value="fixed">Importe $</option></select></label></div><div id="solrakLineDiscountHelp" class="solrakQuickHelp">Descuento manual bloqueado hasta contar con validación productiva.</div><div class="solrakQuickFoot"><button type="button" data-solrak-close="solrakLineEditor">Cancelar</button><button id="solrakApplyLineEdit" class="primary" type="button">Aplicar cantidad</button></div></div>`;
    document.body.appendChild(dialog);
    dialog.querySelectorAll('[data-solrak-close="solrakLineEditor"]').forEach((button) => button.onclick = () => closeDialog(dialog));
    byId("solrakApplyLineEdit").onclick = applyLineEdit;
  }
  function openLineEditor(lineId) {
    const api = pos(), line = api?.cart?.find?.((item) => String(item.id) === String(lineId));
    if (!line) return;
    ensureLineEditor();
    ...
    const enabled = Boolean(discountBridge() && mayDiscount());
  ...
  async function applyLineEdit() {
    ...
    line.qty = qty;
    const bridge = discountBridge(), discountValue = Number(byId("solrakLineDiscountValue")?.value || 0);
    if (bridge && mayDiscount() && discountValue > 0) {
      try { await bridge.applyLineDiscount({ lineId: line.id, value: discountValue, type: byId("solrakLineDiscountType")?.value || "percent" }); }
  ...
  function ensureActionBar() {
    ...
    const serviceButton = bar.querySelector('[data-solrak-action="services"]'), serviceReady = Boolean(servicesBridge());
    if (serviceButton.disabled === serviceReady) serviceButton.disabled = !serviceReady;
    ...
    if (byId("solrakServicesState")?.textContent !== (serviceReady ? "Disponible" : "No configurado")) byId("solrakServicesState").textContent = serviceReady ? "Disponible" : "No configurado";
    const discountButton = bar.querySelector('[data-solrak-action="discount"]'), discountReady = Boolean(globalDiscountBridge() && mayDiscount());
    if (discountButton.disabled === discountReady) discountButton.disabled = !discountReady;
    ...
    if (byId("solrakDiscountState")?.textContent !== (discountReady ? "Disponible" : "No habilitado")) byId("solrakDiscountState").textContent = discountReady ? "Disponible" : "No habilitado";
    return true;
  }
  ...
  function bindSearchState() {
    ...
    input.addEventListener("input", update); input.addEventListener("focus", update); input.addEventListener("blur", () => setTimeout(update, 120)); update();
  }
  ...
  function sync() {
    injectStyle(); ensureSidebar(); ensureThemeDialog();
    if (!themeInitialized) { const saved = themeState(); applyTheme(saved.name, saved.custom); themeInitialized = true; }
    if (!ensureOpsBar()) return false;
    ensureActionBar(); bindCartDoubleClick(); bindSearchState(); installObservers(); syncTopTotal(); syncProductThumb(); pollScaleBridge();
    document.documentElement.dataset.solrakDesktopDensity = "1";
    return true;
  }
  function boot() {
    sync();
    setInterval(() => { sync(); syncTopTotal(); pollScaleBridge(); }, 1200);
    setTimeout(sync, 250); setTimeout(sync, 900);
  }

  if (document.readyState === "loading") document.addEventListener("DOMContentLoaded", boot, { once: true }); else boot();

  window.SOLRAKDesktopDensityV0183 = { version: VERSION, maxTickets: MAX_TICKETS, themes: THEMES, sync, setCollapsed, applyTheme, setScaleReading, openLineEditor, printDraftQuote };
})();
